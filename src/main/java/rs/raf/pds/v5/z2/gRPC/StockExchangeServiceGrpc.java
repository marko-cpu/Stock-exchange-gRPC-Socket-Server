...
public final class StockExchangeServiceGrpc {
  ...
  private static final int METHODID_SUBMIT_ORDER = 1;
  private static final int METHODID_GET_TRADE_LIST = 2;
  private static final int METHODID_GET_CLIENT_PORTFOLIO = 3;
  private static final int METHODID_NOTIFY_TRADE = 4;
  private static final int METHODID_SUBSCRIBE_TO_TRADE_UPDATES = 5;
  private static final int METHODID_GET_STOCK_DATA_BY_DATE_TIME = 6;
  private static final int METHODID_GET_ASK_LIST = 7;
  private static final int METHODID_GET_BID_LIST = 8;
